$(document).ready(function(){
  ...
  $(document).on('click', '.add', function(){
    ...
    $(document).on('click', '.save', function(){
      ...
      tdButtons.html(
        "<button class=\"btn btn-xs btn-outline-danger delete\"><i class=\"material-icons\">delete_forever</i></button>" + " " +
        // "<button class=\"btn btn-xs btn-info edit\"><i class=\"material-icons\">mode_edit</i></button>"+ " " +
        "<button class=\"btn btn-xs btn-outline-warning clone\"><i class=\"material-icons\">content_copy</i></button>" + " " +
        "<button class=\"btn btn-xs btn-outline-success add\"><i class=\"material-icons\">note_add</i></button>"
      );
    });
